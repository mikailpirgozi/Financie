...
import { createIncome, getCurrentHousehold, getCategories, type Category } from '@/lib/api';
...
export default function NewIncomeScreen() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      showToast(
        error instanceof Error ? error.message : 'Nepodarilo sa vytvoriť príjem',
        'error'
      );
    } finally {
      setLoading(false);
    ...
    >
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="handled">
        <View style={[styles.content, { paddingTop: insets.top + 16 }]}>
          <Text style={styles.title}>Nový príjem</Text>
          <Text style={styles.subtitle}>Zaznamenajte nový príjem</Text>
