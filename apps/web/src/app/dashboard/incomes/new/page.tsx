...
export default function NewIncomePage(): React.JSX.Element {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        // Get categories
        const categoriesRes = await fetch(`/api/categories?householdId=${hId}&kind=income`);
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Nový príjem</h1>
        <p className="text-muted-foreground">Zaznamenajte nový príjem</p>
      </div>

      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            <CardTitle>Detaily príjmu</CardTitle>
            <CardDescription>Vyplňte informácie o príjme</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="source"
                placeholder="Názov zamestnávateľa, projektu, atď."
