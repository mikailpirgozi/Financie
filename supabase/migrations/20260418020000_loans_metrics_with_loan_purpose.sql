-- =====================================================
-- ADD loan_purpose to get_loans_with_metrics RPC
-- =====================================================
-- Problem: get_loans_with_metrics RPC doesn't return loan_purpose,
-- so the web/mobile clients can't display loan purpose without
-- an extra round-trip query.
--
-- Solution: Recreate the function and pass through l.loan_purpose.
-- =====================================================
...
COMMENT ON FUNCTION get_loans_with_metrics(uuid) IS
  'Returns loans for household enriched with materialized loan_metrics, loan_purpose and linked asset metadata.';
