 ...
 * Fuel type options.
 *
 * NOTE: DB CHECK constraint allows: petrol | diesel | electric | hybrid | lpg | cng.
 * `plugin_hybrid` is intentionally NOT in this list because the DB would reject it.
 * Until the DB CHECK is broadened, treat plug-in hybrids as `hybrid`.
 */
